...
INSERT INTO ACTOR (NAME, LASTNAME, NATIONALITY)
...
INSERT INTO MOVIE (
    ...
    VALUES (
        ...
        355000,
        1931-02-12,
        (SELECT ID FROM DIRECTOR WHERE GENDERS='AVENTURE' OR GENDERS='SCIENCE FICTION'),
        (SELECT ID FROM CLASIFICATION WHERE GENDERS='AVENTURE' OR GENDERS='SCIENCE FICTION'),
        (SELECT ID FROM COUNTRY WHERE GENDERS='AVENTURE' OR GENDERS='SCIENCE FICTION'),
        (SELECT ID FROM STUDIO WHERE GENDERS='AVENTURE' OR GENDERS='SCIENCE FICTION')
);
