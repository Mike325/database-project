...
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Universal'   , ( SELECT ID FROM COUNTRY WHERE NAME = 'USA'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('FOX'         , ( SELECT ID FROM COUNTRY WHERE NAME = 'USA'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Tequila'     , ( SELECT ID FROM COUNTRY WHERE NAME = 'Mexico'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Vodka Studio', ( SELECT ID FROM COUNTRY WHERE NAME = 'Rusia'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Sorry Studio', ( SELECT ID FROM COUNTRY WHERE NAME = 'Canada'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Kiwis Studio', ( SELECT ID FROM COUNTRY WHERE NAME = 'New Zeland'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Copys'       , ( SELECT ID FROM COUNTRY WHERE NAME = 'China'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Disney'      , ( SELECT ID FROM COUNTRY WHERE NAME = 'USA'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Pixar'       , ( SELECT ID FROM COUNTRY WHERE NAME = 'USA'));
INSERT INTO STUDIO (NAME, LOCATIONID) VALUES ('Dream Works' , ( SELECT ID FROM COUNTRY WHERE NAME = 'USA'));
