...
CREATE OR REPLACE TRIGGER INCOME_MOVIE
    ...
    BEGIN ATOMIC
        ...
        SET MESSAGE_TEXT = ('INVALID INCOME, IT MOST BE HIGHER THAN THE LAST ONE');
    END;
...
CREATE OR REPLACE TRIGGER VALID_INCOME
    ...
    BEGIN ATOMIC
        SIGNAL SQLSTATE '75001'
        SET MESSAGE_TEXT = ('INCOME MUST BE MORE THAN 0');
    END;
...
CREATE OR REPLACE TRIGGER VALID_COST
    ...
    BEGIN ATOMIC
        SIGNAL SQLSTATE '75001'
        SET MESSAGE_TEXT = ('COST MUST BE MORE THAN 0');
    END;
...
CREATE OR REPLACE TRIGGER COST_MOVIE
    ...
    BEGIN ATOMIC
        SIGNAL SQLSTATE '75001'
        SET MESSAGE_TEXT = ('INVALID COST, IT MOST BE HIGHER THAN THE LAST ONE');
    END;
...
CREATE OR REPLACE TRIGGER VALID_DURATION
    ...
    BEGIN ATOMIC
        SIGNAL SQLSTATE '75001'
        SET MESSAGE_TEXT = ('DURATION MUST BE MORE THAN 0');
    END;
